...
namespace IncidentesAPI.Models
{
    public class Sla
    {
        ...
        public class Map
        {
            ...
            public Map(EntityTypeBuilder<Sla> etb)
            {
                etb.HasKey(x => x.SlaId);
                etb.Property(x => x.Descripcion).HasColumnName("Descripcion").HasMaxLength(200);
                etb.Property(x => x.CantidadHoras).HasColumnName("CantidadHoras").HasColumnType("int");
